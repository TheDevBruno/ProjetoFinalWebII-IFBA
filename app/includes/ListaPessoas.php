...
<?php
    ...
    $sqlPesquisa = "SELECT * FROM pessoas where nome LIKE '%$pesquisa%' ";
...
<div class="container mt-5">
    <div class="row">
        <div class="col">
            <h1 class="text-center">Pesquisar Cliente</h1>
                ...
                <tbody>
                    <?php
                        while ($linha = mysqli_fetch_assoc($dados)){
                            ...
                            $data_nascimento = dataNacional($data_nascimento);
                            $foto = $linha['foto'];
                            if(!$foto == null){
                                $mostra_foto = "<img src='../../app/assets/img/$foto' class='lista_foto'>";
                            }else{
                                $mostra_foto = '';
                            }
                        ...
                        echo "<tr>
                                ...
                                <td width=150px> 
                                    <a href='editar_cadastroPessoas.php?id=$cod_pessoa' class='btn btn-success btn-sm'> Editar </a>
